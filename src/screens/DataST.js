                                ...
                                <tbody style={{ height: '12rem', verticalAlign: 'middle' }}>
                                    ...
                                    {studentList.map((val) => {
                                        return (<tr className="table-name-report ">
                                            ...
                                            <td><button type="button" className="btn btn-report " style={{ backgroundColor: '#958F8F', color: '#fff' }}><i aria-hidden="true" className="far fa-edit" style={{ fontSize: 15 }} /><label className="mx-2">แก้ไข</label> </button></td>
                                        </tr>)
                                    })}
                                    ...
                                    {professerList.map((val) => {
                                        return (
                                            <tr className="table-name-report ">
                                                ...
                                                <td>{val.prof_tel}</td>
                                                <td>
                                                    <button type="button" className="btn btn-report " style={{ backgroundColor: '#63B0C0', color: '#fff' }}><i aria-hidden="true" className="fas fa-key" style={{ fontSize: 15 }} /><label className="mx-2">เปลี่ยนรหัสผ่าน</label> </button>
                                                </td>
                                                <td><button type="button" className="btn btn-report " style={{ backgroundColor: '#958F8F', color: '#fff' }}><i aria-hidden="true" className="far fa-edit" style={{ fontSize: 15 }} /><label className="mx-2">แก้ไข</label> </button></td>
                                            </tr>
                                        )
