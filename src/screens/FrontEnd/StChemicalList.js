    ...
    <div className="card" style={{marginTop: '5rem', borderRadius: 15, boxShadow: '0 30px 50px rgb(0 0 0 / 20%)'}}>
      <div className="card-body">
        ...
        <div className="row ">
          ...
          <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 p-3">
            <div className="card cardChemical" style={{width: '20rem'}}>
              <img src="img/Acetic.png" className="card-img-top" alt="..." height={250} />
              <div className="card-body">
                <h5 className="card-title">Card title</h5>
                <div className="row">
                  <div className="col-6">
          ...
          <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3  p-3">
            <div className="card" style={{width: '20rem'}}>
              <img src="img/10.png" className="card-img-top" alt="..." height={250} />
              <div className="card-body">
                <h5 className="card-title">Card title</h5>
                <div className="row">
                  <div className="col-6">
          ...
          <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 p-3">
            <div className="card" style={{width: '20rem'}}>
              <img src="img/silv5021.png" className="card-img-top" alt="..." height={250} />
              <div className="card-body">
                <h5 className="card-title">Card title</h5>
                <div className="row">
                  <div className="col-6">
