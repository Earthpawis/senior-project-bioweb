...
import { rChemicalList, rReadChe, rAddChemical, rUpdateChe, rDelChe, rReadTool,
  rUpdateTool, rDelTool, rToolsList, rAddTool, rImgChemical, rImgTools} from '../route/BackRoute'
            ...
            <div className="row" key={key}>
              ...
              <div className="col-xl-3">
                <div className="form-group mb-3">
                  <div className="image-upload">
                    <img src={`${rImgChemical}` + val.ch_img} alt style={{ width: '7rem', marginTop: '5rem' }} />
                    <input className="form-control mt-4" type="file" name="upload_file" onChange={handleInputChange4}/>
                  </div>
                </div>
              </div>
