          ...
          <div className="panels">
            <div className="panel" id="one-panel">
              <table className="table table-responsive">
                <thead>
                  <tr>
                    <th className="headname-th" scope="col" width="3%" style={{ minWidth: 107, textAlign: 'center' }}> <span>ลำดับ</span> </th>
              ...
              <div className="row" key={key}>
                ...
                <div className="col-xl-3">
                  <div className="form-group mb-3">
                    <div className="image-upload">
                      <img src={`${rImgChemical}` + val.ch_img} alt style={{ width: '7rem', marginTop: '5rem' }} />
                      <input className=" mt-4" type="file" name="upload_file" />
                    </div>
                  </div>
                </div>
        ...
        <Modal.Body>
          <div className="row">
            <div className="col-xl-4 col-lg-5 col-md-5 col-12 col-sm-12">
              ...
              <div className="row mb-3">
                <label htmlFor className="col-xl-5 col-lg-3 col-md-3 col-sm-3 col-xs-4  col-4 col-form-label form-name labal-name-mie mt-2">ลำดับ
                  :
                </label>
                <div className="col-xl-7 col-lg-9 col-md-9 col-sm-9 col-xs-8 col-8 mt-2">
                  <input type="text" className="input-text form-control " id formcontrolname disabled />
            ...
            return (
              <div className="row" key={key}>
                <div className="col-xl-4 col-lg-5 col-md-5 col-12 col-sm-12">
                  ...
                  <div className="row mb-3">
                    <label for="" className="col-xl-5 col-lg-3 col-md-3 col-sm-3 col-xs-4  col-4 col-form-label form-name text-end">ลำดับ :
                    </label>
                    <div className="col-xl-7 col-lg-9 col-md-9 col-sm-9 col-xs-8 col-8 mt-2">
                      {val.tool_id}
                    </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-xl-2 col-lg-9 col-md-9 col-sm-9 col-xs-8 col-8 mt-2">
                      {val.tool_amount}
                    </div>
                  </div>
                </div>
            ...
            return (
              <div className="row" key={key}>
                ...
                <div className="col-xl-3">
                  <div className="form-group mb-3">
                    <div className="image-upload">
                      <img src={`${rImgTools}` + val.tool_img} alt style={{ width: '7rem', marginTop: '4rem' }} />
                      <input className='mt-2' type="file" onChange={handleInputChange2} />
                    </div>
                  </div>
                </div>
                <div className="row mt-4">
